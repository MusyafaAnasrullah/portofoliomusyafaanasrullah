document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    id: {
      ...
      hero_sub_slogan: "Berfokus pada pengembangan aplikasi web modern, API, dan solusi perangkat lunak yang terukur.",
      ...
      exp_org_jmh_desc: "Memimpin komunitas Jamiatul Huffadz, mengoordinasikan anggota, menyusun program kegiatan (pembinaan tahfidz, kajian rutin), serta mengambil keputusan dan membagi tugas ke pengurus lain.",
    ...
    zh: {
      ...
      hero_welcome: "高级软件工程",
      hero_greeting: "你好，我是",
      hero_full_slogan: '"构建可靠、可扩展且有意义的数字解决方案。"',
      hero_sub_slogan: "专注于构建现代 Web 应用程序、API 和可扩展的软件解决方案。",
      ...
      p1_desc: "专业个人作品集网站，支持深色/浅色模式、交互式粒子动画、多语言 (i18n) 及响应式设计。",
      p2_desc: "综合软件工程项目展示平台，含交互式画廊、动态分类筛选及模态项目详情展示。",
      p3_desc: "个人财务追踪应用，具备实时分析图表、自动支出分类、月度 PDF 报告及多账户同步。",
      p4_desc: "多功能后台管理面板，支持基于角色的用户管理、实时分析、活动审计日志及系统通知。",
      p5_desc: "企业级库存管理系统，支持实时库存追踪、自动补货提醒、商品动态报告及条形码扫描集成。",
      p6_desc: "现代化网页收银系统，具备快速交易处理、产品与折扣管理、每日销售报告及热敏打印机集成。",
      ...
      exp_org_jmh_desc: "领导 Jamiatul Huffadz 社区，协调成员，组织活动计划（古兰经背诵辅导、定期研讨），并分配任务。",
    ...
    ja: {
      ...
      hero_welcome: "シニアソフトウェアエンジニアリング",
      hero_greeting: "こんにちは、",
      hero_full_slogan: '"信頼性が高く、拡張可能で、意味のあるデジタルソリューションを構築します。"',
      hero_sub_slogan: "モダンな Web アプリケーション、API、および拡張可能なソフトウェアソリューションの構築に注力しています。",
      ...
      exp_org_jmh_desc: "Jamiatul Huffadz コミュニティを率い、メンバーの統括、活動プログラム（暗記指導、定期勉強会）の企画、役員への業務分担を担当。",
    ...
    ko: {
      ...
      hero_welcome: "시니어 소프트웨어 엔지니어링",
      hero_greeting: "안녕하세요, 저는",
      hero_full_slogan: '"신뢰할 수 있고 확장 가능하며 의미 있는 디지털 솔루션을 구축합니다."',
      hero_sub_slogan: "현대적인 웹 애플리케이션, API 및 확장 가능한 소프트웨어 솔루션 구축에 집중하고 있습니다.",
      ...
      exp_org_jmh_desc: "Jamiatul Huffadz 커뮤니티를 이끌며 회원 조정, 활동 프로그램 기획 및 업무 분담 총괄.",
    ...
    es: {
      ...
      hero_welcome: "Ingeniería de Software Senior",
      hero_greeting: "Hola, soy",
      hero_full_slogan: '"Construyendo soluciones digitales confiables, escalables y significativas."',
      hero_sub_slogan: "Enfocado en crear aplicaciones web modernas, API y soluciones de software escalables.",
      ...
      exp_org_jmh_desc: "Lideró la comunidad Jamiatul Huffadz, coordinando miembros, organizando programas de actividades y delegando tareas a la junta directiva.",
    ...
    fr: {
      ...
      hero_welcome: "Ingénierie Logicielle Senior",
      hero_greeting: "Bonjour, je suis",
      hero_full_slogan: '"Créer des solutions numériques fiables, évolutives et significatives."',
      hero_sub_slogan: "Axé sur la création d'applications web modernes, d'API et de solutions logicielles évolutives.",
      ...
      exp_org_jmh_desc: "A dirigé la communauté Jamiatul Huffadz, coordonné les membres, organisé les programmes d'activités et délégué les tâches.",
    ...
    de: {
      ...
      hero_full_slogan: '"Entwicklung zuverlässiger, skalierbarer und bedeutungsvoller digitaler Lösungen."',
      hero_sub_slogan: "Fokussiert auf die Entwicklung moderner Webanwendungen, APIs und skalierbarer Softwarelösungen.",
      ...
      exp_org_jmh_desc: "Leitung der Jamiatul Huffadz-Gemeinschaft, Koordination der Mitglieder, Organisation von Programmen und Aufgabenverteilung.",
    ...
    pt: {
      ...
      hero_welcome: "Engenharia de Software Sênior",
      hero_greeting: "Olá, eu sou",
      hero_full_slogan: '"Construindo soluções digitais confiáveis, escaláveis e significativas."',
      hero_sub_slogan: "Focado na construção de aplicações web modernas, APIs e soluções de software escaláveis.",
      ...
      exp_org_jmh_desc: "Liderou a comunidade Jamiatul Huffadz, coordenando membros, organizando programas de atividades e delegando tarefas.",
    ...
    ar: {
      ...
      hero_welcome: "هندسة البرمجيات العالية",
      hero_greeting: "مرحباً، أنا",
      hero_full_slogan: '"بناء حلول رقمية موثوقة وقابلة للتطوير وذات مغزى."',
      hero_sub_slogan: "التركيز على بناء تطبيقات الويب الحديثة وواجهات برمجة التطبيقات وحلول البرمجيات القابلة للتطوير.",
      ...
      exp_org_jmh_desc: "قاد مجتمع جمعية الحفاظ، ونسق الأعضاء، ونظم البرامج، وفوض المهام لأعضاء مجلس الإدارة.",
    ...
    it: {
      ...
      hero_welcome: "Ingegneria del Software Senior",
      hero_greeting: "Ciao, sono",
      hero_full_slogan: '"Creazione di soluzioni digitali affidabili, scalabili e significative."',
      hero_sub_slogan: "Focalizzato sulla creazione di applicazioni web moderne, API e soluzioni software scalabili.",
      ...
      exp_org_jmh_desc: "Ha guidato la comunità Jamiatul Huffadz, coordinando i membri, organizzando programmi di attività e delegando compiti.",
    ...
    ru: {
      ...
      hero_welcome: "Старшая Инженерия ПО",
      hero_greeting: "Привет, я",
      hero_full_slogan: '"Создание надежных, масштабируемых и значимых цифровых решений."',
      hero_sub_slogan: "Фокус на создании современных веб-приложений, API и масштабируемых программных решений.",
      ...
      exp_org_jmh_desc: "Руководил сообществом Jamiatul Huffadz, координировал участников, организовывал программы и распределял задачи.",
    ...
    tr: {
      ...
      hero_welcome: "Kıdemli Yazılım Mühendisliği",
      hero_greeting: "Merhaba, ben",
      hero_full_slogan: '"Güvenilir, ölçeklenebilir ve anlamlı dijital çözümler üretmek."',
      hero_sub_slogan: "Modern web uygulamaları, API'ler ve ölçeklenebilir yazılım çözümleri geliştirmeye odaklı.",
      ...
      exp_org_jmh_desc: "Jamiatul Huffadz topluluğunu yönetti, üyeleri koordine etti, programları organize etti ve görev dağılımı yaptı.",
    ...
    nl: {
      ...
      hero_full_slogan: '"Het bouwen van betrouwbare, schaalbare en waardevolle digitale oplossingen."',
      hero_sub_slogan: "Gefocust op het bouwen van moderne webapplicaties, API's en schaalbare software-oplossingen.",
      ...
      exp_org_jmh_desc: "Leidde de Jamiatul Huffadz-gemeenschap, coördineerde leden, organiseerde programma's en delegeerde taken.",
    ...
    hi: {
      ...
      hero_welcome: "वरिष्ठ सॉफ्टवेयर इंजीनियरिंग",
      hero_greeting: "नमस्ते, मैं हूं",
      hero_full_slogan: '"विश्वसनीय, स्केलेबल और अर्थपूर्ण डिजिटल समाधानों का निर्माण।"',
      hero_sub_slogan: "आधुनिक वेब अनुप्रयोगों, एपीआई और स्केलेबल सॉफ्टवेयर समाधानों के निर्माण पर केंद्रित।",
      ...
      exp_org_jmh_desc: "जामियातुल हुफ्फाज समुदाय का नेतृत्व किया, सदस्यों का समन्वय किया और कार्यक्रमों का आयोजन किया।",
  ...
  const documentData = {
    cert: {
      ...
      subtitle: "Bukti kompetensi dan keahlian yang telah diraih (26 Sertifikat)",
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Sertifikat workshop AI-Powered Software Engineering oleh Codelamp Indonesia (Narasumber: Muhammad Razif Rizqullah, S.T., M.T.), mempelajari integrasi AI tools untuk efisiensi coding, refactoring, code analysis, dan software workflow modern."
        },
        {
          ...
          desc: "Sertifikat workshop integrasi OpenRouter oleh Codelamp Indonesia (Narasumber: M. Iqbal Rahmatullah), mempelajari pemanfaatan satu API universal untuk menghubungkan berbagai model Large Language Model (LLM)."
        },
        {
        ...
        },
        {
          ...
          desc: "Sertifikat resmi kelulusan kursus online dan transkrip nilai Game Design Documentation oleh Codelamp Indonesia (Instruktur: Ibnu Raziq), mencakup penyusunan Game Design Document (GDD), core loop, dan arsitektur gameplay."
        },
        {
          ...
          desc: "Sertifikat workshop Game Direction Fundamentals oleh Codelamp Indonesia (Narasumber: Aldo Layongga), mempelajari dasar-dasar penyutradaraan game, perancangan visi kreatif, mekanik permainan, dan alur pengalaman pemain."
        },
        {
          ...
          desc: "Sertifikat workshop animasi 2D oleh Codelamp Indonesia (Narasumber: Roni Y. Ertanto), mendalami teknik skeletal rigging, mesh deformation, dan pipeline animasi karakter game 2D menggunakan Spine."
        },
        {
          title: "Sertifikat Peserta Pertamuda Seed and Scale",
          issuer: "PT Pertamina (Persero)",
          category: "Technology & Startup Innovation",
          date: "2026",
          path: "assets/images/sertifikat/Sertifikat Pertamuda.pdf",
          desc: "Sertifikat resmi kepesertaan ajang kompetisi inovasi bisnis rintisan pemuda nasional Pertamuda (Pertamina Muda) Seed and Scale yang diselenggarakan oleh PT Pertamina (Persero)."
        },
        {
          title: "Sertifikat Sekolah Pasar Modal (SPM)",
          ...
          desc: "Sertifikat resmi penyelesaian edukasi Sekolah Pasar Modal oleh Bursa Efek Indonesia (BEI) bersama Phintraco Sekuritas mengenai investasi saham, analisis fundamental, dan teknikal."
        },
        {
          title: "Sertifikat Seminar Entrepreneur & Digital Business",
          ...
          desc: "Sertifikat partisipasi dalam seminar nasional kewirausahaan, membahas strategi membangun startup digital, model bisnis inovatif, dan kepemimpinan."
        },
        {
          title: "Sertifikat Keterangan Lulus Pengabdian",
          issuer: "Pondok Modern Darussalam Gontor / Pondok An-Nibras",
          category: "Pengabdian & Kepemimpinan",
          date: "2024",
          path: "assets/images/sertifikat/Sertifikat Keterangan Lulus Pengabdian.pdf",
          desc: "Sertifikat resmi keterangan telah menyelesaikan masa pengabdian (khidmat) sebagai tenaga pendidik dan pembina bahasa santri, membuktikan dedikasi sosial dan integritas."
        },
        {
          title: "Sertifikat Dauroh Qur'an 14 Hari di Bulan Ramadhan",
          issuer: "Pondok Modern Darussalam Gontor",
          category: "Pendidikan Agama Islam",
          date: "2022",
          path: "assets/images/sertifikat/Sertifikat Dauroh Qur'an  14 Hari Di Bulan Ramadhan.pdf",
          desc: "Sertifikat kelulusan program intensif Dauroh Qur'an selama 14 hari penuh di bulan suci Ramadhan, mencakup tahsin, pendalaman kaidah tajwid, dan tilawah Al-Qur'an."
        },
        {
          title: "Sertifikat Tahfidz Qur'an Juz 29 & 30",
          issuer: "Lembaga Tahfidz Al-Qur'an / Pondok Modern Darussalam Gontor",
          category: "Pendidikan Agama Islam",
          date: "2023",
          path: "assets/images/sertifikat/Sertifikat Tahfidz Qur'an Juz 29 & 30.pdf",
          desc: "Sertifikat resmi atas pencapaian hafalan Al-Qur'an Juz 29 dan Juz 30 (Juz 'Amma) dengan bacaan tartil, makharijul huruf yang fasih, dan penguasaan tajwid yang matang."
        },
        {
          title: "Sertifikat Kenaikan Tingkat Karate INKAI",
          ...
          desc: "Sertifikat resmi ujian kenaikan tingkat dan kelulusan sabuk bela diri karate dari Institut Karate-Do Indonesia (INKAI), mencakup penguasaan teknik dasar Kihon, Kata, dan Kumite."
        },
        {
          title: "Sertifikat Peragaan Manasik Haji",
          issuer: "Panitia Peragaan Manasik Haji & Edukasi Islam",
          category: "Pendidikan Agama & Praktik Ibadah",
          date: "2015",
          path: "assets/images/sertifikat/Sertifikat Peragaan Manasik Haji.pdf",
          desc: "Sertifikat keikutsertaan dalam pelatihan dan peragaan manasik haji praktis, mempelajari rukun, tata cara tawaf, sa'i, dan wukuf sesuai tuntunan syariat."
        },
        {
          title: "Sertifikat Peserta Kegiatan Polisi Sahabat Anak (PSA)",
          issuer: "Kepolisian Republik Indonesia (POLRI)",
          ...
          desc: "Sertifikat partisipasi aktif dalam kegiatan Polisi Sahabat Anak (PSA) oleh POLRI, program pembinaan disiplin dini, kepatuhan hukum, dan karakter generasi muda."
        },
        {
          title: "Sertifikat Sanggar Lukis Anak",
          issuer: "Sanggar Seni Rupa & Lukis Anak",
          category: "Seni & Kreativitas",
          date: "2013",
          path: "assets/images/sertifikat/Sertifikat Sanggar Lukis Anak.pdf",
          desc: "Sertifikat partisipasi dalam program sanggar lukis anak, mengembangkan daya imajinasi, ekspresi artistik, dan kreativitas visual seni rupa sejak usia dini."
        }
      ]
    },
    piagam: {
      ...
      items: [
        {
          ...
          issuer: "Panitia Kejuaraan Nasional Taekwondo",
          category: "National Martial Arts Championship",
          date: "2025",
          path: "assets/images/piagam/Piagam Penghargaan Juara 2 Kyorugi Senior Putra U 61 kg.pdf",
          desc: "Piagam Penghargaan Resmi Juara 2 (Medali Perak) Kategori Kyorugi (Tanding) Senior Putra Kelas Under 61 kg pada Kejuaraan Taekwondo Tingkat Nasional."
        },
        {
          title: "Piagam Penghargaan Juara 2 Kyorugi Taekwondo",
          issuer: "Pengurus Cabang Taekwondo Indonesia",
          category: "Martial Arts Championship",
          date: "2025",
          path: "assets/images/piagam/Piagam Juara 2 Kyorugi.pdf",
          desc: "Piagam prestasi Juara 2 (Silver Medalist) cabang pertarungan Kyorugi Taekwondo atas ketangguhan strategi tanding, kecepatan tendangan, dan sportivitas arena."
        },
        {
          title: "Piagam Penghargaan Kejuaraan Karate",
          issuer: "Panitia Kejuaraan Karate Antar Ranting / INKAI",
          category: "Martial Arts Championship",
          date: "2014",
          path: "assets/images/piagam/Piagam Penghargaan Kejuaraan Karate.pdf",
          desc: "Piagam penghargaan atas prestasi dan pencapaian dalam kejuaraan karate, membuktikan dedikasi dan disiplin tinggi dalam seni bela diri."
        },
        {
          title: "Piagam Penghargaan Peserta Pekan Olahraga & Seni (PORSENI)",
          issuer: "Panitia Pekan Olahraga dan Seni Pelajar",
          category: "Olahraga & Seni",
          date: "2014",
          path: "assets/images/piagam/Piagam Penghargaan Peserta Dalam Olahraga Dan Seni.pdf",
          desc: "Piagam penghargaan atas keikutsertaan aktif dalam kompetisi Pekan Olahraga dan Seni, menjunjung tinggi sportivitas, kerjasama tim, dan bakat seni."
        },
        {
          title: "Piagam Penghargaan Peserta Lomba Mewarnai Kreatif",
          issuer: "Panitia Festival Kreativitas Seni Anak",
          category: "Seni & Kreativitas",
          date: "2013",
          path: "assets/images/piagam/Piagam Penghargaan Peserta Lomba Mewarnai.pdf",
          desc: "Piagam penghargaan atas partisipasi dalam lomba mewarnai kreatif anak, menunjukkan bakat perpaduan warna dan ketelitian artistik sejak usia dini."
        },
        {
          ...
          desc: "Piagam penghargaan istimewa atas keberhasilan menyelesaikan program Dauroh Al-Qur'an intensif 40 hari penuh mencakup 30 Juz beserta pemahaman terjemahannya."
        }
      ]
    },
    medal: {
      ...
      items: [
        {
          title: "Medali Perak (Silver Medalist) Pancasila Cup 2",
          issuer: "Panitia Kejuaraan Nasional Taekwondo Pancasila Cup 2",
          category: "National Taekwondo Championship",
          date: "2025",
          path: "assets/images/medali/Mendali Pancasila Cup 2.pdf",
          desc: "Sertifikat & Dokumen Resmi Piagam Kejuaraan Nasional Taekwondo Pancasila Cup 2, membuktikan raihan prestasi gemilang Juara 2 (Medali Perak) Tingkat Nasional."
        }
      ]
    }
  };
  ...
  const sampleProjects = {
    p1: {
      ...
      status: "Live",
      year: "2026",
      tech: ["HTML5", "CSS3", "JavaScript", "i18n", "Canvas API"],
      ...
      body: "Situs portofolio personal profesional dengan mode gelap/terang, animasi partikel interaktif berbasis Canvas, dan dukungan multi-bahasa (i18n) untuk 15+ bahasa. Dibangun tanpa framework eksternal menggunakan vanilla HTML, CSS, dan JavaScript murni dengan performa tinggi dan desain responsif premium.",
      features: [
        "Dark / Light Mode dengan toggle animasi halus",
        "15+ bahasa dengan sistem i18n kustom",
        "Animasi partikel interaktif berbasis Canvas",
        "Desain responsif penuh untuk semua perangkat",
        "Filter proyek, modal detail, dan efek 3D tilt"
      ]
    },
    p2: {
      ...
      features: [
        ...
        "Modal detail proyek dengan preview gambar",
        "Animasi Framer Motion yang halus",
        "Backend Node.js + MongoDB untuk manajemen proyek",
        "Responsif penuh dan SEO-friendly"
      ]
    },
    p3: {
  ...
  document.querySelectorAll('.demo-trigger').forEach(trigger => {
    trigger.addEventListener('click', (e) => {
      ...
      if (data) {
        ...
        const featureList = data.features.map(f => `<li><i class="fa-solid fa-circle-check"></i> ${f}</li>`).join('');

        if (pModalBody) {
          pModalBody.innerHTML = `
            <div class="p-modal-meta">
              <span class="project-badge ${statusClass}">${data.status}</span>
              <span class="p-modal-year"><i class="fa-regular fa-calendar"></i> ${data.year}</span>
            </div>
            <p class="p-modal-desc">${data.body}</p>
            <div class="p-modal-section">
              <h4><i class="fa-solid fa-list-check"></i> Fitur Utama</h4>
              <ul class="p-modal-features">${featureList}</ul>
            </div>
            <div class="p-modal-section">
              <h4><i class="fa-solid fa-code"></i> Tech Stack</h4>
              <div class="p-modal-tech">${techBadges}</div>
            </div>
          `;
        }
